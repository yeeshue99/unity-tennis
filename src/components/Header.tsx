...
export default function Header() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-80 bg-(--color-sidebar-bg) text-(--color-text) shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
